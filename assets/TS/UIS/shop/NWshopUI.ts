...
DXJ(){
   ...
   NWshopM.NWDJ=true;
    ...
    k=this.mArr1Arr2(k,k,k,k,k,k,k)
        ...
        console.log(NWshopM.NWN)
            this.A1.children[0].getComponent(Sprite).spriteFrame= this.AM.getComponent(Shops).find(2,NWshopM.NWN[0],"",0)
            this.A2.children[0].getComponent(Sprite).spriteFrame= this.AM.getComponent(Shops).find(2,NWshopM.NWN[1],"",0)
            this.A3.children[0].getComponent(Sprite).spriteFrame= this.AM.getComponent(Shops).find(2,NWshopM.NWN[2],"",0)
            this.A4.children[0].getComponent(Sprite).spriteFrame= this.AM.getComponent(Shops).find(2,NWshopM.NWN[3],"",0)
            this.A5.children[0].getComponent(Sprite).spriteFrame= this.AM.getComponent(Shops).find(2,NWshopM.NWN[4],"",0)

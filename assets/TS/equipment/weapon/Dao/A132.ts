...
@ccclass('A132')
export default class A132 extends Dao {
  level: number = 3
  TheNumber: string = "A132";
  Aface: number[] = [1,2,3];
DT:boolean=true;
Wtype: number=1;
  ac(k:number) {
...
//        面向对齐
       ...
       MessageCenter.MakeSHMessage("AM", an,GeZiManager.AT,this.node.getComponent(Character).Pturn, "wuli")
